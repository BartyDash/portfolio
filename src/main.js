...
fetch(`https://api.github.com/users/${username}/repos?sort=${sort}`)
  ...
  .then((response) => {
    for (let repository of response) {
      ...
      const element = `<article class="rounded-round20px bg-gradient-to-br from-white/10 to-white/5">
        <div
        ...
        <div class="p-5 md:p-6 lg:p-10">
            ...
            <div class="flex flex-col md:flex-row gap-4 items-start">
                <a class="bg-bg text-primary flex gap-2 font-bold py-4 px-5 items-center rounded-round10px md:rounded-xl md:text-xl border-lightGray border-2"
